...
import '../Forms/HadabyForm.dart';
class HadabyDetails extends StatefulWidget {
  const HadabyDetails({Key? key}) : super(key: key);

  @override
  State<HadabyDetails> createState() => _HadabyDetailsState();
}

class _HadabyDetailsState extends State<HadabyDetails> {
  @override
